...
// doneボタンを押した時にDatePikerとツールバーを消す
...
- (IBAction)registerButton:(id)sender {
    ...
    // tableにinsert
    NSString *insertTable = @"INSERT INTO tr_todo(`todo_title`, `todo_contents`, `created`, `modified`, `limit_date`, `delete_flg`) VALUES(:todo_title, :todo_contents, :created, :modified, :limit_date, :delete_flg);";
    ...
    if (trimTodoTitle.length != 0) {
        [db executeUpdate:insertTable withParameterDictionary:@{@"todo_title":trimTodoTitle,
